...
from .dataset import CUB, CarsDataset, NABirds, dogs, INat2017, CSVDataSet
...
def get_loader(args):
    ...
    if args.dataset == 'CUB_200_2011':
        ...
        test_transform = transforms.Compose([
                            ...
                            transforms.ToTensor(),
                            transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        train_file = '/data2/zzc/PycharmProjects/acc-vit-car/Aircraft/train.csv'
        test_file = '/data2/zzc/PycharmProjects/acc-vit-car/Aircraft/test.csv'
        img_root = '/data/zhangzichao/datasets/fgvc-aircraft-2013b/data/images'

        trainset = CSVDataSet(train_file, img_root, train_transform)
        testset = CSVDataSet(test_file, img_root, train_transform)
